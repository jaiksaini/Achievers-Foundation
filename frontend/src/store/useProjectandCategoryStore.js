...
export const useProjectAndCategoryStore = create((set, get) => ({
  ...
  deleteProject: async (id) => {
    try {
      await axiosInstance.delete(`/api/projects/delete/${id}`);
  ...
  getCategories: async () => {
    try {
      const res = await axiosInstance.get("/api/projects/categories");
  ...
  deleteCategory: async (category) => {
    try {
      await axiosInstance.delete(`/api/category/delete/${category}`);
      set({
