...
const TeamSection = () => {
    ...
    <section className="py-12 px-4 md:px-12 bg-white text-center">
      ...
      <div className="flex justify-center gap-4 mb-10">
        <button className="bg-purple-800 text-white px-5 py-2 rounded-lg shadow hover:bg-purple-900 transition" onClick={() => navigate("/about")}>
          About us
        </button>
        <button className="bg-gray-200 text-gray-700 px-5 py-2 rounded-lg shadow hover:bg-gray-300 transition" onClick={() => navigate("/contact")}>
          Contact Us
        </button>
      </div>
